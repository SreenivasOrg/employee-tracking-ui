...
// // //     if (valid) {
// // //       try {
// // //         // Sending data as URLSearchParams (form data)
// // //         const params = new URLSearchParams();
// // //         params.append("email", email); // Use "username" to match the backend
...
// // //         setLoginMessage(response.data); // Display the response message from the backend
// // //       } catch (error) {
...
//     }
//     if (!validatePassword(password)) {
//       newErrors.password = "Password must be at least 6 characters, and contain a letter and a number.";
//       valid = false;
//     }
